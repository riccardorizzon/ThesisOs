...
export function CreateChapterButton({
      ...
      >
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button
            type="submit"
            disabled={busy}
            className="rounded-md bg-accent px-3 py-1.5 text-sm font-medium text-ink-inverse hover:bg-accent/90 disabled:opacity-50 cursor-pointer"
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "inline-flex rounded-md bg-accent px-4 py-2 text-sm font-medium text-ink-inverse",
